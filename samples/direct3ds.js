...
GATEWAY_URL="https://gateway.exampledomainhere.com/direct/"
...
app.get("/direct3ds", function (req, res) {
	...
	Gateway.directUrl = GATEWAY_URL; // https://gateway.exampledomainhere.com/direct/
...
app.post("/direct3ds", function (req, res) {
	...
	let acsResponse = {
		...
		threeDSRef: "",
		threeDSResponse: {},
		directUrl: GATEWAY_URL // https://gateway.exampledomainhere.com/direct/"
	};
